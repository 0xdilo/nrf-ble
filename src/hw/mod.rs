...
//! API.
//!
//! Requires one of the `nrf52811`, `nrf52832` or `nrf52840` features.
#[cfg(not(any(feature = "nrf52811", feature = "nrf52832", feature = "nrf52840")))]
compile_error!("one of the `nrf52811`, `nrf52832` or `nrf52840` features must be enabled");

#[cfg(all(feature = "nrf52811", any(feature = "nrf52832", feature = "nrf52840")))]
compile_error!("features `nrf52811`, `nrf52832` and `nrf52840` are mutually exclusive");
